...
export function Backstory() {
    ...
    return (
        <section className="relative py-32 overflow-hidden bg-black min-h-[600px]">
            {/* Content */}
            <div className="relative z-10 container mx-auto px-4">
                <div className="max-w-2xl mx-auto mb-20">
                    <h2 className="text-5xl md:text-6xl font-bold bg-clip-text text-transparent bg-white mb-4 text-center">
                        Our Story
                    </h2>
                    ...
                    <div className="relative">
                        <div
                            ...
                            } shadow-lg h-[500px] overflow-hidden flex flex-col justify-end`}
                        >
                                            ...
                                            {msg.sender === 'timestamp' ? (
                                                ...
                                                <div className={`flex items-start space-x-3 ${
                                                    ...
                                                    <div className="flex-1">
                                                        ...
                                                        <div className={`p-3 rounded-lg text-white border ${
                                                            msg.sender === 'Arstos'
                        ...
                        {/* Founder Cards - Positioned absolutely outside chat */}
                        {/* Bhaskar Card - Left */}
